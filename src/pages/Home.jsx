...
<div className="max-w-7xl mx-auto px-4 py-12 grid md:grid-cols-2 gap-8 items-center">
        ...
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-6 bg-white rounded-lg shadow-lg">
              <img src="/src/assets/Home/high quality.jpeg" alt="Quality" className="w-full h-auto rounded-md mb-4" />
            ...
            <div className="p-6 bg-white rounded-lg shadow-lg">
              <img src="/src/assets/Home/fast service.jpeg" alt="Fast Service" className="w-full h-auto rounded-md mb-4"  />
            ...
            <div className="p-6 bg-white rounded-lg shadow-lg">
              <img src="/src/assets/Home/affordable price.jpeg" alt="Affordable" className="w-full h-auto rounded-md mb-4" />
  ...
  <div className="grid md:grid-cols-3 gap-8">
    <div className="p-6 bg-white rounded-lg shadow-lg text-center">
     <img 
  src="/src/assets/Home/slider/repairing.jpg" 
  alt="Sofa Repair" 
  className="w-full h-auto rounded-md mb-4" 
/>
      <h3 className="text-xl font-semibold mb-2">Sofa Repair</h3>
      <p className="text-gray-600">Restore your old sofa with premium materials.</p>
    </div>
    <div className="p-6 bg-white rounded-lg shadow-lg text-center">
      <img src="/src/assets/Home/custom sofa.png" alt="Custom Sofa" className="w-full h-auto rounded-md mb-4" />
      <h3 className="text-xl font-semibold mb-2">Custom Sofa</h3>
      <p className="text-gray-600">Get a sofa designed exactly the way you want.</p>
    </div>
    <div className="p-6 bg-white rounded-lg shadow-lg text-center">
      <img src="/src/assets/Home/fabric change.jpeg" alt="Fabric Change" className="w-full h-auto rounded-md mb-4" />
      <h3 className="text-xl font-semibold mb-2">Fabric Change</h3>
      <p className="text-gray-600">Choose from hundreds of fabric styles and colors.</p>
    </div>
  </div>
